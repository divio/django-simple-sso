...
from simple_sso.utils import SyncConsumer, gen_secret_key
from tests.urls import test_client
from tests.utils.context_managers import SettingsOverride, UserLoginContext
...
class SimpleSSOTests(TestCase):
    ...
    def test_user_data_updated(self):
        ...
        Tests whether sso server user data changes will be forwared to the client on the
        user's next login.
